<div class="col-md-8 form-information">
    ...
    <form action="{{route('user.infor.update', ['id'=>$user->id])}}" method="post">
        ...
        <div class="form-row">
            ...
            <input type="text" class="form-control" id="user-name" name="name" placeholder="Nhập họ và tên của bạn"
        ...
        <div class="form-row row">
            ...
            <div class="col-md-3">
                <input class="form-check-input" type="radio" name="gender" id="male_gender" value="Nam" {{ $user->gender
                == 'Nam' ? "checked" : ''}}>

                <label class="form-check-label" for="radio2"> Nam</label> &ensp; &ensp;

                <input type="radio" class="form-check-input" id="radio1" name="gender" value="Nữ" {{ $user->gender ==
                'Nữ' ? "checked" : ''}}>
        ...
        <div class="form-row">
            ...
            <input type="text" class="form-control" id="birthday" name="birthday" required value="{{ date(" d-m-Y",
